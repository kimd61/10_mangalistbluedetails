...
// Handle navigation search - now searches within the current page
function handleNavSearch() {
    const searchQuery = navSearchInput.value.trim();
    if (searchQuery) {
        // Instead of redirecting to browse page, we could show an alert or implement in-page search
        alert(`Search functionality is coming soon! You searched for: ${searchQuery}`);
...
function createMangaCard(manga) {
    ...
    // Add click event to navigate to manga detail page
